...
- Node.js instalado
- Clonar e executar a [API](https://github.com/Erika-Bernardo/banco-api) e a [aplicação Web](https://github.com/Erika-Bernardo/banco-web)

## Instalação

1. Clone este repositório:
   ```bash
   git clone https://github.com/Erika-Bernardo/banco-web-tests.git
   cd banco-web-tests
   ```
